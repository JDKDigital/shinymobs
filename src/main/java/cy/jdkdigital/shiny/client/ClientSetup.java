...
@EventBusSubscriber(modid = ShinyMod.MODID, value = Dist.CLIENT, bus = EventBusSubscriber.Bus.MOD)
public class ClientSetup
{
    ...
    public static void registerEntityRendering(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerEntityRenderer(ModEntities.WARDEN.get(), ShinyWardenRenderer::new);
