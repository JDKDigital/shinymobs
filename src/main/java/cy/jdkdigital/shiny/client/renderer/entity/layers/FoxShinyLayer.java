...
{
    private static final RenderType RED_FOX_TEXTURE = RenderType.eyes(new ResourceLocation("textures/entity/fox/fox.png"));
    private static final RenderType RED_FOX_SLEEP_TEXTURE = RenderType.eyes(new ResourceLocation("textures/entity/fox/fox_sleep.png"));
    private static final RenderType SNOW_FOX_TEXTURE = RenderType.eyes(new ResourceLocation("textures/entity/fox/snow_fox.png"));
    private static final RenderType SNOW_FOX_SLEEP_TEXTURE = RenderType.eyes(new ResourceLocation("textures/entity/fox/snow_fox_sleep.png"));
