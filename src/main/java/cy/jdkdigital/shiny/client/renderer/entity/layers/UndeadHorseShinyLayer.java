...
public class UndeadHorseShinyLayer extends RenderLayer<AbstractHorse, HorseModel<AbstractHorse>>
{
    private static final Map<EntityType<?>, RenderType> SHINE = ImmutableMap.of(
            ModEntities.ZOMBIE_HORSE.get(), RenderType.eyes(ResourceLocation.fromNamespaceAndPath(ShinyMod.MODID, "textures/entity/horse/horse_zombie.png")),
            ModEntities.SKELETON_HORSE.get(), RenderType.eyes(ResourceLocation.fromNamespaceAndPath(ShinyMod.MODID, "textures/entity/horse/horse_skeleton.png"))
    );
