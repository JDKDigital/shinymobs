...
public class LlamaShinyLayer extends RenderLayer<Llama, LlamaModel<Llama>>
{
    ...
    {{
        put(Llama.Variant.CREAMY, RenderType.eyes(ResourceLocation.fromNamespaceAndPath(ShinyMod.MODID, "textures/entity/llama/creamy.png")));
        put(Llama.Variant.WHITE, RenderType.eyes(ResourceLocation.fromNamespaceAndPath(ShinyMod.MODID, "textures/entity/llama/white.png")));
        put(Llama.Variant.BROWN, RenderType.eyes(ResourceLocation.fromNamespaceAndPath(ShinyMod.MODID, "textures/entity/llama/brown.png")));
        put(Llama.Variant.GRAY, RenderType.eyes(ResourceLocation.fromNamespaceAndPath(ShinyMod.MODID, "textures/entity/llama/gray.png")));
    }};
