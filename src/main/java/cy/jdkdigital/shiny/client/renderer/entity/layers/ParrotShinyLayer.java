...
public class ParrotShinyLayer extends RenderLayer<Parrot, ParrotModel>
{
    private static final RenderType[] SHINE = new RenderType[]{
        RenderType.eyes(new ResourceLocation("textures/entity/parrot/parrot_red_blue.png")),
        RenderType.eyes(new ResourceLocation("textures/entity/parrot/parrot_blue.png")),
        RenderType.eyes(new ResourceLocation("textures/entity/parrot/parrot_green.png")),
        RenderType.eyes(new ResourceLocation("textures/entity/parrot/parrot_yellow_blue.png")),
        RenderType.eyes(new ResourceLocation("textures/entity/parrot/parrot_grey.png"))
    };
