...
public class HorseShinyLayer extends RenderLayer<Horse, HorseModel<Horse>>
{
    private static final Map<Variant, RenderType> SHINE = Util.make(Maps.newEnumMap(Variant.class), (map) -> {
        map.put(Variant.WHITE, RenderType.eyes(new ResourceLocation(ShinyMod.MODID, "textures/entity/horse/horse_white.png")));
        map.put(Variant.CREAMY, RenderType.eyes(new ResourceLocation(ShinyMod.MODID, "textures/entity/horse/horse_creamy.png")));
        map.put(Variant.CHESTNUT, RenderType.eyes(new ResourceLocation(ShinyMod.MODID, "textures/entity/horse/horse_chestnut.png")));
