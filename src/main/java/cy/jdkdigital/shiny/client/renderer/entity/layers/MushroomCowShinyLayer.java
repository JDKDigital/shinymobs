...
public class MushroomCowShinyLayer extends RenderLayer<MushroomCow, CowModel<MushroomCow>>
{
    private static final Map<MushroomCow.MushroomType, RenderType> SHINE = Util.make(Maps.newHashMap(), (map) -> {
        map.put(MushroomCow.MushroomType.BROWN, RenderType.eyes(ResourceLocation.fromNamespaceAndPath(ShinyMod.MODID, "textures/entity/cow/brown_mooshroom.png")));
        map.put(MushroomCow.MushroomType.RED, RenderType.eyes(ResourceLocation.fromNamespaceAndPath(ShinyMod.MODID, "textures/entity/cow/red_mooshroom.png")));
    });
