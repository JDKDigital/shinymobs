...
public class ModEntities
{
    ...
    public static final RegistryObject<EntityType<Axolotl>> AXOLOTL = register("shiny_axolotl", EntityType.Builder.of(Axolotl::new, MobCategory.AXOLOTLS).sized(0.75F, 0.42F).clientTrackingRange(10));
    ...
    public static final RegistryObject<EntityType<Cod>> COD = register("shiny_cod", EntityType.Builder.of(Cod::new, MobCategory.WATER_AMBIENT).sized(0.5F, 0.3F).clientTrackingRange(4));
    ...
    public static final RegistryObject<EntityType<Pufferfish>> PUFFERFISH = register("shiny_pufferfish", EntityType.Builder.of(Pufferfish::new, MobCategory.WATER_AMBIENT).sized(0.7F, 0.7F).clientTrackingRange(4));
    ...
    public static final RegistryObject<EntityType<Salmon>> SALMON = register("shiny_salmon", EntityType.Builder.of(Salmon::new, MobCategory.WATER_AMBIENT).sized(0.7F, 0.4F).clientTrackingRange(4));
    ...
    public static final RegistryObject<EntityType<TropicalFish>> TROPICAL_FISH = register("shiny_tropical_fish", EntityType.Builder.of(TropicalFish::new, MobCategory.WATER_AMBIENT).sized(0.5F, 0.4F).clientTrackingRange(4));
    ...
    public static final RegistryObject<EntityType<ZombieVillager>> ZOMBIE_VILLAGER = register("shiny_zombie_villager", EntityType.Builder.of(ZombieVillager::new, MobCategory.MONSTER).sized(0.6F, 1.95F).clientTrackingRange(8));
