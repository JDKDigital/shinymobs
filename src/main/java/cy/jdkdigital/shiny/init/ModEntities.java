...
public class ModEntities
{
    ...
    public static final RegistryObject<EntityType<ShinyHusk>> HUSK = register("shiny_husk", EntityType.Builder.of(ShinyHusk::new, MobCategory.MONSTER).sized(0.6F, 1.95F).clientTrackingRange(8));
    ...
    public static final RegistryObject<EntityType<ShinySkeleton>> SKELETON = register("shiny_skeleton", EntityType.Builder.of(ShinySkeleton::new, MobCategory.MONSTER).sized(0.6F, 1.99F).clientTrackingRange(8));
    ...
    public static final RegistryObject<EntityType<ShinyVillager>> VILLAGER = register("shiny_villager", EntityType.Builder.of(ShinyVillager::new, MobCategory.MISC).sized(0.6F, 1.95F).clientTrackingRange(10));
